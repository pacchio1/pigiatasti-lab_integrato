...
Inoltre, la classe è annotata con "@Service" per indicare che è un componente di servizio e "@RequiredArgsConstructor" per iniettare automaticamente le dipendenze tramite il costruttore.
          </li>
